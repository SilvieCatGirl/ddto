...
var grayFilter = new ShaderFilter(grayShader);
	...
	var extra1:Character;
	var extra2:Character;
...
function onLoad()
{
		...
		add(darkoverlay);
				...
				titleCard.frames = Paths.getSparrowAtlas('titlecards/home');
